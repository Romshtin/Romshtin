...
**Хранит заметки и находит нужную информацию по смыслу, а не только по точному слову**
...
## 🔍 Поиск людей под задачи в Telegram/VK

**Сбор и фильтрация публичных постов и комментариев по заданным критериям**

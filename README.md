...
- **Автоматизация с ИИ** — создаю умные инструменты, которые сами решают задачи: от создания сайтов под конкретные нужды до разработки AI-чат-ботов с памятью и пониманием контекста
- **Project Management** — вырастаю из hands-on инженера в руководителя проекта, управляю командами и продуктами
